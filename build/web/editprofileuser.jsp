<%-- Document : editprofileuser Created on : Oct 11, 2023, 12:08:27 AM Author : overw --%>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="text-center text-sm-right">
                                                        <select class="custom-select bg-success text-light">
                                                            ...
                                                            <option ${roleNow eq 'MEMBER' ? 'selected' : '' }>Member
                                                            </option>
                                                            <option ${roleNow eq 'STAFF' ? 'selected' : '' } value="1">
                                                                Staff</option>
                                                        </select>
                                                                    ...
                                                                    <div class="col mb-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" rows="5"
                                                                                placeholder="${us.description == "" ? us.description : "
                                                                                My
                                                                                bio"}">${us.description == "" ? us.description : "My bio"}</textarea>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
