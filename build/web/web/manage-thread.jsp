...
<html>
    ...
    <body>
        ...
        <div class="container mt-4">
            ...
            <!-- Thread Title -->
            <div class="row">
                <h1 class="col-md-10 d-flex justify-content-start">Optimizing Feline Wellness: Health Tips for Cats and Dogs</h1>
                <div class="btn-group mb-3 col-md-2 d-flex justify-content-end">
                    <form action="manage-threads.jsp">
                        <button type="submit" class="btn btn-success">Accept</button>
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#rejectPostModal">Reject</button>
                    </form>
                </div>
            </div>
            <!-- Thread Author -->
