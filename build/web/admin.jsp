                        ...
                        <div class="col-md-12">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <c:forEach var="s" items="${listOfStaff}">
                                                                <tr>
                                                                    <td>${s.user_id}</td>
                                                                    <td><a
                                                                            href="DispatcherController?action=manage&actions=viewprofile&usname=${s.user_id}">${s.fullname}</a>
                                                                    </td>
                                                                    <td>${s.email}</td>
                                                                    ...
                                                                    <td class="text-center">
                                                                        ...
                                                                        <form action="ActionController" method="post">
                                                                            <input type="hidden" value="${s.user_id}"
                                                                                name="username" />
                                                                            <button value="delete" name="action"
                                                                                class="btn btn-danger">
                                                                                <i class="fa fa-trash"></i>
                                                                            </button>
                                                                            <button value="ban" name="action"
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="staff" items="${staffs}">
                                                    <tr>
                                                        <td>${staff.user_id}</td>
                                                        <td><a
                                                                href="DispatcherController?action=manage&actions=viewprofile&usname=${staff.user_id}">${staff.fullname}</a>
                                                        </td>
                                                        <td>${staff.email}</td>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <form action="ActionController" method="post">
                                                                ...
                                                                <button name="action" value="ban" class="btn btn-danger"
                                                                    data-toggle="modal" data-target="#modal-promote">
                            ...
                            <div class="card">
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="member" items="${members}">
                                                    <tr>
                                                        ...
                                                        <td><a
                                                                href="DispatcherController?action=manage&actions=viewprofile&usname=${member.user_id}">${member.fullname}</a>
                                                        </td>
                                                        <td>${member.email}</td>
                                            ...
                                            <tbody>
                                                ...
                                                <c:forEach var="m" items="${listOfMember}">
                                                    <tr>
                                                        <td>${m.user_id}</td>
                                                        <td><a
                                                                href="DispatcherController?action=manage&actions=viewprofile&usname=${m.user_id}">${m.fullname}</a>
                                                        </td>
                                                        <td>${m.email}</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <form action="ActionController" method="post">
                                                            ...
                                                            <button value="ban" name="action" type="button"
                                    ...
                                    >>>>>>> 43121dce8fcd02461ca07b7c117261c9b302b607
                                </div>
                            </div>
                        </div>
                    </div>
