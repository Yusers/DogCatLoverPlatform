                                ...
                                <div class="card-body chat-container">
                                    <div class="chat-messages" id="chat">
                                        <c:forEach var="m" items="${listMess}">
                                            <div class="${m.sender_id == us.user_id ? 'my-message' : 'other-message'}">
                                                <strong>${m.sender_id == us.user_id ? us.user_id :
                                                    m.sender_id}:</strong> ${m.content}
                                            </div>
                                        </c:forEach>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <form action="DispatcherController" method="POST">
                                        ...
                                        <input type="hidden" name="receiver_id"
                                            value="${listMess.get(0).receiver_id}" />
                                        <input type="hidden" name="conversation_id"
                                            value="${listMess.get(0).conversation_id}" />
                                        <div class="input-group">
                                            <input type="text" name="content" required="*" id="msg" class="form-control"
                        ...
                        <div class="row pt-5">
                            <div class="col-lg-4 col-md-12 mb-5">
                                <h1 class="mb-3 display-5 text-capitalize text-white"><span
                                        class="text-primary">Dog&Cat</span>Lover</h1>
                                <p class="m-0">Chung toi hi vong nen tang nay se giup ban trong viec cham soc thu cung
                                    va hay tham gia dien dan de ban co the tham gia trao doi voi nha nhu trao doi cho,
                                    meo, do dung cua cho hoac meo va dich vu cham soc thu cung</p>
                            </div>
                            <div class="col-lg-8 col-md-12">
                                <div class="row">
                                    <div class="col-md-4 mb-5">
                                        <h5 class="text-primary mb-4">Get In Touch</h5>
                                        <p><i class="fa fa-map-marker-alt mr-2"></i>Nha van hoa sinh vien, Tp.Thu Duc,
                                            VN</p>
                        ...
                        <div class="row">
                            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                                <p class="m-0 text-white">
                                    &copy; <a class="text-white font-weight-bold" href="#"> Donate</a> de giup tui minh
                                    phat trien them nha. All Rights Reserved.
