<%-- Document : tradingpage Created on : Oct 4, 2023, 2:16:48 PM Author : overw --%>
...
>>>>>>> e171e003676125de96cd90488e7a930a3436b26f
                ...
                <div class="container mt-5 mb-5">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div style="height: 400px" id="carouselExampleIndicators" class="carousel slide">
                                ...
                                <div style="height: 100%" class="carousel-inner">
                                    <div style="height: 100%" class="carousel-item active">
                                        <div style="height: 100%" class="card">
                                            <img style="height: 100%; object-fit: contain;" src="${trade.image}"
                        ...
                        <div class="col-md-4 justify-content-center">
                            <form action="DispatcherController" method="POST">
                                ...
                                <input type="hidden" name="topic" value="${trade.title} | ${trade.author_id}" />
                                <div class="user">
                                    <div class="user-info">
                                    ...
                                    <div class="user-action">
                                        <c:if test="${not empty us.role}"><button type="submit"
                                                class="btn btn-primary btn-block">Contact Seller</button></c:if>
                                        <c:if test="${empty us.role}"><button class="btn btn-primary btn-block"
                                                type="button" onclick="showLoginPrompt()">Contact Seller</button></c:if>
                                    </div>
                                </div>
                            </form>
                            <br>
