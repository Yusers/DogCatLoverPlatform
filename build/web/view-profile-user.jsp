                        ...
                        <c:if test="${sessionScope.USER.role == 'ADMIN'}">
                            <div class="col-md-2">
                                <input type="button" class="profile-edit-btn btn-primary" name="btnAddMore"
                                    value="Edit Profile"
                                    onclick="window.location.href = `DispatcherController?action=manage&actions=editprofileuser&usname=${us.user_id}`" />
                            </div>
                        </c:if>
                    </div>
                    <div class="row">
                ...
                <div class="row pt-5">
                    <div class="col-lg-4 col-md-12 mb-5">
                        <h1 class="mb-3 display-5 text-capitalize text-white"><span
                                class="text-primary">Dog&Cat</span>Lover</h1>
                        <p class="m-0">Chung toi hi vong nen tang nay se giup ban trong viec cham soc thu cung va hay
                            tham gia dien dan de ban co the tham gia trao doi voi nha nhu trao doi cho, meo, do dung cua
                            cho hoac meo va dich vu cham soc thu cung</p>
                    </div>
