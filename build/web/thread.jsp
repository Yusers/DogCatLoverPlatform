                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <c:if test="${us.role eq 'STAFF'}">
                                                    <a class="dropdown-item"
                                                        href="DispatcherController?action=staff-manage">Dash board</a>
                                                </c:if>
                                                <a class="dropdown-item" href="DispatcherController?action=my-post">My
                                                    Posts</a>
                                                <a class="dropdown-item" href="LoadConversationController">Chat</a>
                                                <a class="dropdown-item" href="DispatcherController?action=logout">Log
                                                    out</a>
                                            </div>
                                        </div>
                                    </c:when>
                    ...
                    <div class="row py-3 px-lg-5">
                        <div class="col-lg-4">
                            <a href="" class="navbar-brand d-none d-lg-block">
                                <h1 class="m-0 display-5 text-capitalize"><span class="text-primary">Dog&Cat</span>Lover
                                </h1>
                            </a>
                        </div>
                                ...
                                <div class="author">
                                    ...
                                    <div class="author-container">
                                        <div class="author-info">
                                            <c:if test="${us.role != null}">
                                                <h6><a
                                                        href="DispatcherController?action=manage&actions=viewprofile&usname=${post.author_id}">${post.author_id}</a>
                                                </h6>
                                            </c:if>
                                            <c:if test="${us.role == null}">
                                                <h6><a href="login.jsp">${post.author_id}</a></h6>
                                            </c:if>
                                            <p>${post.created_at}</p>
                                        </div>
                                        <div class="post-action">
                                            <a href="#"><svg xmlns="http://www.w3.org/2000/svg" height="1.8em"
                            ...
                            <div class="card mb-4">
                                <div class="card-body">
                                    <div class="alert alert-secondary" role="alert">
                                        Chúng tôi rất vui mừng khi chào đón bạn vào cộng đồng của chúng tôi. Đây là nơi
                                        để chia sẻ ý kiến, hỏi đáp và kết nối với những người có sở thích tương tự.
                        ...
                        <div class="col-md-12 replies">
                            <div class="comment">
                                <div class="user-info">
                                    ...
                                    <span>
                                        <c:if test="${us.role != null}"><a
                                                href="DispatcherController?action=manage&actions=viewprofile&usname=${us.user_id}">${us.user_id
                                                != null ? us.user_id : "Guess"}</a></c:if>
                                        <c:if test="${us.role == null}"><a href="login.jsp">${us.user_id != null ?
                                                us.user_id : "Guess"}</a></c:if>
                                    </span>
                                </div>
                                <form action="DispatcherController" method="POST">
                                    ...
                                    <c:choose>
                                        <c:when test="${empty us.role}">
                                            <input placeholder="Write a comment..." value="" type="text"
                                                class="form-control" aria-label="Sizing example input" disabled
                                                aria-describedby="inputGroup-sizing-sm">
                                            <button class="btn btn-primary mt-2" type="button"
                                                onclick="showLoginPrompt()">Comment</button>
                                        </c:when>
                                        <c:when test="${us.role eq 'ADMIN' or us.role eq 'STAFF'}">
                                            <input placeholder="You are not allowed to comment." type="text"
                                                class="form-control" aria-label="Sizing example input"
                                                aria-describedby="inputGroup-sizing-sm" disabled>
                                        </c:when>
                                        <c:otherwise>
                                            <input id="commentInput" name="content" required="*"
                                                placeholder="Write a comment..." type="text" class="form-control"
                                    ...
                                    <c:when test="${comment.parent_id == 0}">
                                        ...
                                        <div class="comment">
                                            <div class="user-info">
                                                ...
                                                <span>
                                                    <c:if test="${us.role != null}"><a
                                                            href="DispatcherController?action=manage&actions=viewprofile&usname=${comment.author_id}">${comment.author_id}</a>
                                                    </c:if>
                                                    <c:if test="${us.role == null}"><a
                                                            href="login.jsp">${comment.author_id}</a></c:if>
                                                </span>
                                            </div>
                                            <p>${comment.content}</p>
                                            <a class="cus-comment text-primary" data-toggle="collapse"
                                                data-target="#replyFormTop${comment.id}">Reply</a>
                                            <div class="mt-1 ml-4 collapse" id="replyFormTop${comment.id}">
                                                <div class="user-info">
                                                    ...
                                                    <span><a
                                                            href="DispatcherController?action=manage&actions=viewprofile&usname=NhatNTM">${us.user_id
                                                            != null ? us.user_id : "Guess"}</a></span>
                                                </div>
                                                <form action="DispatcherController" method="POST">
                                                    <input type="hidden" name="action" value="comment" />
                                                    <input type="hidden" name="post-id" value="${post.id}" />
                                                    ...
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${us.role eq 'ADMIN' or us.role eq 'STAFF'}">
                                                            <input placeholder="You are not allowed to comment."
                                            ...
                                            <c:forEach var="sub"
                                                items="${CommentDAO.getSubComment(post.id, comment.id)}">
                                                <div class="sub-reply pl-4">
                                                    <div class="user-info">
                                                        ...
                                                        <span><a
                                                                href="DispatcherController?action=manage&actions=viewprofile&usname=NhatNTM">${sub.author_id}</a></span>
                                                    </div>
                                                    <p>${sub.content}</p>
                                                    <a class="cus-comment text-primary" data-toggle="collapse"
                ...
                <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
                    <div class="row pt-5">
                        <div class="col-lg-4 col-md-12 mb-5">
                            <h1 class="mb-3 display-5 text-capitalize text-white"><span
                                    class="text-primary">Dog&Cat</span>Lover</h1>
                            <p class="m-0">Chung toi hi vong nen tang nay se giup ban trong viec cham soc thu cung va
                                hay tham gia dien dan de ban co the tham gia trao doi voi nha nhu trao doi cho, meo, do
                                dung cua cho hoac meo va dich vu cham soc thu cung</p>
                        </div>
                        <div class="col-lg-8 col-md-12">
                            <div class="row">
                                <div class="col-md-4 mb-5">
                                    <h5 class="text-primary mb-4">Get In Touch</h5>
                                    <p><i class="fa fa-map-marker-alt mr-2"></i>Nha van hoa sinh vien, Tp.Thu Duc, VN
                                    </p>
                                ...
                                <div class="col-md-4 mb-5">
                                    ...
                                    <div class="d-flex flex-column justify-content-start">
                                        ...
                                        <a class="text-white mb-2" href="#"><i
                                                class="fa fa-angle-right mr-2"></i>Forums</a>
                                        <a class="text-white mb-2" href="#"><i
                                                class="fa fa-angle-right mr-2"></i>Trade</a>
                    ...
                    <div class="row">
                        <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                            <p class="m-0 text-white">
                                &copy; <a class="text-white font-weight-bold" href="#"> Donate</a> de giup tui minh phat
                                trien them nha. All Rights Reserved.
