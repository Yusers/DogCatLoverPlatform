<%-- 
    Document   : forums-post
    Created on : Nov 16, 2023, 11:56:19 AM
    Author     : ADMIN
--%>
    ...
    <body>
                            ...
                            <c:otherwise>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item" href="DispatcherController?action=view-profile">View Profile</a>
        ...
        <div class="container mt-5">
            ...
            <div class="container mt-5">
                ...
                <div class="col-md-9">
                    <c:forEach var="c" items="${requestScope.SUBCATEGORIES}">
                        <!-- Thread cate 1 -->
