<%-- Document : manage-threads Created on : Oct 11, 2023, 12:30:58 AM Author : overw --%>
                                        ...
                                        <c:forEach var="post" items="${posts}">
                                                ...
                                                <div class="card-header" id="thread${post.id}">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                            ...
                                                            data-target="#collapseThread${post.id}" aria-expanded="true"
                                                            aria-controls="collapseThread${post.id}">
                                                            ${post.title}
                                                        </button>
                                                    </h2>
                                                </div>

                                                <div id="collapseThread${post.id}" class="collapse"
                                                    aria-labelledby="thread${post.id}" data-parent="#threadAccordion">
                                                    <div class="card-body">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <p>Thể Loại:
                                                                        ${Post_CategoryDAO.getPostCategory(post.cate_id).name}
                                                                    </p>
                                                                ...
                                                                <div class="row">
                                                                    <div
                                                                        class="btn-group col-md-4 d-flex justify-content-start">
                                                                        <button class="btn btn-danger">Delete</button>
                                                                        <button class="btn btn-primary">Edit</button>
                                                                    </div>
                                                                    <div class="col-md-6"></div>
                                                                    <div class="col-md-2 d-flex justify-content-end">
                                                                        <a href="manage-thread.jsp"
                                                                            class="text text-primary">More Details</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="thread2">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                            data-toggle="collapse" data-target="#collapseThread2"
                                                            aria-expanded="true" aria-controls="collapseThread2">
                                                            Thread Title 2
                                                        </button>
                                                    </h2>
                                                </div>

                                                <div id="collapseThread2" class="collapse" aria-labelledby="thread2"
                                                    data-parent="#threadAccordion">
                                                    <div class="card-body">
                                                        <div class="card">
                                                            <div class="card-header">
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6"></div>
                                                                    <div
                                                                        class="btn-group col-md-2 d-flex justify-content-end">
                                                                        <a href="manage-thread.jsp"
                                                                            class="text text-primary">More Details</a>
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="thread3">
                                                    <h2 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                            data-toggle="collapse" data-target="#collapseThread3"
                                                            aria-expanded="true" aria-controls="collapseThread3">
                                                            Thread Title 3
                                                        </button>
                                                    </h2>
                                                </div>

                                                <div id="collapseThread3" class="collapse" aria-labelledby="thread3"
                                                    data-parent="#threadAccordion">
                                                    <div class="card-body">
                                                        <div class="card">
                                                            <div class="card-header">
