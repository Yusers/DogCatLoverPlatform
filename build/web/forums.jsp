<%-- Document : forums Created on : Oct 2, 2023, 9:36:03 AM Author : ADMIN --%>
                        ...
                        <div class="breadcrumb justify-content-around">
                            <div class="input-group">
                                ...
                                <a class="custom-btn form-control"
                                    href="${us.user_id != null ? 'create-post.jsp' : 'login.jsp'}">Create post...</a>
                            </div>
                        </div>
                    </nav>
                                            ...
                                            <c:forEach var="p" items="${requestScope.POSTS}">
                                                <c:if test="${p.cate_id eq c.id}">
                                                    ...
                                                    <li class="list-group-item"><a
                                                            href="DispatcherController?action=thread&id=${p.id}">${p.title}</a>
                                                    </li>
                                                </c:if>
                                            </c:forEach>
