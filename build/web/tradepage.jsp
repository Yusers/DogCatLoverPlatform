<%-- Document : tradepage Created on : Oct 4, 2023, 12:19:15 AM Author : overw --%>
                                            ...
                                            <c:otherwise>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="LoadConversationController">Chat</a>
                                                        <a class="dropdown-item"
                            ...
                            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
                                ...
                                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                                    <div class="navbar-nav mr-auto py-0">
                                        ...
                                        <a href="DispatcherController?action=forums"
                                            class="nav-item nav-link">Forums</a>
                                        <a href="DispatcherController?action=trade"
                                            class="nav-item nav-link active">Trade</a>
                            ...
                            <nav aria-label="breadcrumb">
                                ...
                                <div class="breadcrumb justify-content-around">
                                    <div class="input-group">
                                        ...
                                        <a class="custom-btn form-control"
                                            href="${us.user_id != null ? 'create-post.jsp' : 'login.jsp'}">Create
                                            post...</a>
                                    </div>
                                </div>
                            </nav>
                                ...
                                <c:forEach var="trade" items="${requestScope.TRADES}">
                                    <div class="col-lg-4 mb-4">
                                        <div class="card border-0 mb-2">
                                            <img class="card-img-top img-fluid" src="${trade.image}"
                                                alt="${trade.title}">
                                                ...
                                                <div class="d-flex mb-3">
                                                    <small class="mr-2"><i class="fa fa-user text-muted"></i>
                                                        <c:if test="${us.role != null}"><a
                                                                href="DispatcherController?action=manage&actions=viewprofile&usname=${trade.author_id}">${trade.author_id}</a>
                                                        </c:if>
                                                        <c:if test="${us.role == null}"><a
                                                                href="login.jsp">${trade.author_id}</a></c:if>
                                                    </small>
                                                    <small class="mr-2"><i class="fa fa-folder text-muted"></i> <a
                                                            href="#">${Trade_CategoryDAO.getTradeCateName(trade.cate_id)}</a></small>
                                                </div>
                                                <p class="text-truncate">${trade.content}</p>
                                                <a href="DispatcherController?action=trade-details&id=${trade.id}"
                            ...
                            <div class="row pt-5">
                                <div class="col-lg-4 col-md-12 mb-5">
                                    <h1 class="mb-3 display-5 text-capitalize text-white"><span
                                            class="text-primary">Dog&Cat</span>Lover</h1>
                                    <p class="m-0">Chung toi hi vong nen tang nay se giup ban trong viec cham soc thu
                                        cung va hay tham gia dien dan de ban co the tham gia trao doi voi nha nhu trao
                                        doi cho, meo, do dung cua cho hoac meo va dich vu cham soc thu cung</p>
                                </div>
                                <div class="col-lg-8 col-md-12">
                                    <div class="row">
                                        <div class="col-md-4 mb-5">
                                            <h5 class="text-primary mb-4">Get In Touch</h5>
                                            <p><i class="fa fa-map-marker-alt mr-2"></i>Nha van hoa sinh vien, Tp.Thu
                                                Duc, VN</p>
                            ...
                            <div class="row">
                                <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                                    <p class="m-0 text-white">
                                        &copy; <a class="text-white font-weight-bold" href="#"> Donate</a> de giup tui
                                        minh phat trien them nha. All Rights Reserved.
                                    </p>
                                </div>
