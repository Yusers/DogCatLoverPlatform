<%-- 
    Document   : manage-thread
    Created on : Oct 11, 2023, 1:16:56 AM
    Author     : overw
--%>
...
<html>
    <head>
        ...
        <title>Quản Lý Bài Viết | Cat Dog Lover Website </title>
    </head> 
    ...
    <body>
        ...
        <div class="container mt-4">
            ...
            <!-- Thread Title -->
            <div class="row">
                <h1 class="col-md-8 d-flex justify-content-start">${post.title}</h1>
                <div class="btn-group mb-3 col-md-4 d-flex justify-content-end">
                    <div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <!-- Thread img -->
                            <img style="object-fit: scale-down; height: 22rem;" src="${empty post.image? 'assets/img/no-img.jpg' : post.image}" class="card-img-top thread-img" alt="${post.title}"><br>
                            <p>
                                ${post.content}
                            </p>
                        </div>
