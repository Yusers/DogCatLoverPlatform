<%-- Document : contact Created on : Oct 2, 2023, 9:36:12 AM Author : ADMIN --%>
            ...
            <body>
                ...
                <div class="container mt-4">
                    ...
                    <div class="d-flex flex-column text-center mb-5 pt-5">
                        ...
                        <h1 class="display-5 m-0">Please complete request<span class="text-primary">.We will assist you
                                as soon as possible.</span></h1>
                    </div>
                        ...
                        <div class="col-12 col-sm-8 mb-5">
                            <div class="contact-form">
                                ...
                                <form name="sentMessage" id="contactForm" novalidate="novalidate">
                                    ...
                                    <div class="control-group">
                                        <input type="text" class="form-control p-4" id="phone"
