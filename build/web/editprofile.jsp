                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                                                <div class="text-center text-sm-left mb-2 mb-sm-0">
                                                    ...
                                                    <div class="text-muted"><small>Last update: ${us.updated_at}</small></div>
                                                    <div class="mt-2">
                                    ...
                                    <div class="tab-content pt-3">
                                        <div class="tab-pane active">
                                            <form action="EditProfileController" method="post" class="form" novalidate>
                                                <input class="form-control" type="hidden" name="username" value="${us.user_id}">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="row">
                                                            <div class="col">
                                                        ...
                                                        <div class="row">
                                                            <div class="col mb-3">
                                                                <div class="form-group">
                                                                    <label>About</label>
                                                                    <textarea class="form-control" rows="5" name="description" value="${us.description}">${us.description}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
